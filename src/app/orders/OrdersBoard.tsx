...
export function OrdersBoard(props: {
  ...
  const filtered = useMemo(() => {
    ...
    if (q) {
      list = list.filter((o) => {
        const hay = `${displayOrderCustomerName(o.customerName, o.storeType)} ${o.branchName} ${o.contact ?? ""} ${o.location ?? ""} ${o.itemsSearchText} ${o.itemsSummary} #${o.id} ${o.storeType}`.toLowerCase();
        ...
        <table className="w-full min-w-[760px] text-[11px]">
          <thead className="sticky top-0 z-10 bg-surface-elevated text-left text-[10px] text-zinc-500">
            <tr>
              ...
              <th className="hidden px-2 py-1.5 sm:table-cell">Branch</th>
          ...
          <tbody className="divide-y divide-white/5">
            {filtered.length === 0 ? (
              ...
              filtered.map((o) => {
                ...
                const customerLabel = displayOrderCustomerName(
                  o.customerName,
                  o.storeType,
                );
                const isWalkIn = customerLabel.startsWith("Walk-in");
                  ...
                  <tr key={o.id} className="align-top hover:bg-white/[0.03]">
                    ...
                    <td className="px-2 py-2">
                      ...
                      {!isWalkIn ? (
                        ...
                        <div className="text-[10px] text-zinc-500">Shop counter</div>
                      )}
                    </td>
